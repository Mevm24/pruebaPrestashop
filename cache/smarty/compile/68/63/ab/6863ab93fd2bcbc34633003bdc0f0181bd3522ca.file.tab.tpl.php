...
<?php /*%%SmartyHeaderCode:116075a78c3d0cddd44-24745030%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6863ab93fd2bcbc34633003bdc0f0181bd3522ca' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop_pruebas\\themes\\leo_exist\\sub\\product_info\\tab.tpl',
      1 => 1517862364,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '116075a78c3d0cddd44-24745030',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a78c3d100ff67_20312452',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a78c3d100ff67_20312452')) {function content_5a78c3d100ff67_20312452($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include 'C:\\xampp\\htdocs\\prestashop_pruebas\\tools\\smarty\\plugins\\function.cycle.php';
...
<ul class="nav nav-tabs tab-info page-product-heading">
	...
	<?php if ($_smarty_tpl->tpl_vars['product']->value->description) {?>
		<li><a href="#tab2" data-toggle="tab"><?php echo smartyTranslate(array('s'=>'More info'),$_smarty_tpl);?>
</a></li>
	<?php }?>
...
?>
						<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
							...
							<div class="product_block col-sp-12 col-xs-6 col-md-3 col-lg-3 item ajax_block_product<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']) {?> first_item<?php } elseif ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']) {?> last_item<?php } else { ?> item<?php }?> product_accessories_description">
												...
												<div class="action-button">
													...
													<?php if (isset($_smarty_tpl->tpl_vars['quick_view']->value)&&$_smarty_tpl->tpl_vars['quick_view']->value) {?>
													  <div class="button-quick-view">
														<a class="quick-view btn btn-tooltip" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
">
											...
											<div class="product-desc">
												<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),110,'...');?>
...
">
												...
												<div class="detail-link">
													<a itemprop="url" class="button lnk_view btn btn-outline" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
