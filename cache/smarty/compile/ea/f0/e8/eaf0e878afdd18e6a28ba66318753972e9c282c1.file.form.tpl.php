<?php /* Smarty version Smarty-3.1.19, created on 2018-02-05 14:47:46
         compiled from "C:\xampp\htdocs\prestashop_pruebas\modules\leotempcp\views\templates\admin\_configure\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6615a78b4e2b11606-29765040%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eaf0e878afdd18e6a28ba66318753972e9c282c1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop_pruebas\\modules\\leotempcp\\views\\templates\\admin\\_configure\\helpers\\form\\form.tpl',
      1 => 1517859999,
      2 => 'file',
    ),
    'e98d692590638f6d9bda8c72e59fe6ddbbc0aceb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop_pruebas\\admin455dhvxiw\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1504540662,
      2 => 'file',
    ),
    'fc7bab735c2f9bc1681a5b0ed45590bc7d3ba3cb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashop_pruebas\\admin455dhvxiw\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1504540662,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6615a78b4e2b11606-29765040',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a78b4e37c30f3_38910204',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a78b4e37c30f3_38910204')) {function content_5a78b4e37c30f3_38910204($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\xampp\\htdocs\\prestashop_pruebas\\tools\\smarty\\plugins\\function.counter.php';
?>
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='setting_list') {?>
            <ol class="breadcrumb leo-redirect">
                <li class="active"><?php echo smartyTranslate(array('s'=>'Setting List'),$_smarty_tpl);?>
</li>
                <li><a href="#" data-element="fieldset_0"><?php echo smartyTranslate(array('s'=>'GENERAL SETTING'),$_smarty_tpl);?>
</a></li>
                <li><a href="#" data-element="fieldset_1"><?php echo smartyTranslate(array('s'=>'PAGES SETTING'),$_smarty_tpl);?>
</a></li>
                <li><a href="#" data-element="fieldset_2"><?php echo smartyTranslate(array('s'=>'CUSTOMIZATION SETTING'),$_smarty_tpl);?>
</a></li>
                <li><a href="#" data-element="fieldset_3"><?php echo smartyTranslate(array('s'=>'FONT SETTING'),$_smarty_tpl);?>
</a></li>
                <li><a href="#" data-element="fieldset_4"><?php echo smartyTranslate(array('s'=>'DATA SAMPLE'),$_smarty_tpl);?>
</a></li>
            </ol>
        <?php }?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='img_cat') {?>
                ...
                <div class="form-group form-select-icon">
                                <label class="control-label col-lg-3 " for="categories"> <?php echo smartyTranslate(array('s'=>'Categories'),$_smarty_tpl);?>
 </label>
                                <div class="col-lg-9">
                                <?php echo $_smarty_tpl->tpl_vars['tree']->value;?>

                                </div>
                                <input type="hidden" name="category_img" id="category_img" value='<?php echo $_smarty_tpl->tpl_vars['selected_images']->value;?>
'/>
...
?>
                        					<li><a href="#"><img height = '10px' src='<?php echo $_smarty_tpl->tpl_vars['image']->value["path"];?>
		...
		<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='slide') {?>
			...
			jQuery(document).ready(function(){
				...
				$(".updateslide").click( function(){
					var id_slide = <?php echo $_smarty_tpl->tpl_vars['slide_edit']->value['id_slide'];?>
;
			...
			function getSlide(edit)
			 {
				...
				var imgUrl = '<?php echo $_smarty_tpl->tpl_vars['pathimg']->value;?>
';
				var thumUrl ='<?php echo $_smarty_tpl->tpl_vars['paththum']->value;?>
';
				...
				if(edit){
					<?php if ($_smarty_tpl->tpl_vars['slide_edit']->value&&$_smarty_tpl->tpl_vars['slide_edit']->value['id_slide']) {?>
					var html = "<div class='col-lg-1'>"+<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value['id_slide'];?>
+"</div><div  class='col-lg-2'>"+this_title+"</div><div class='col-lg-5'>"+src_img+"</div><div class='col-lg-2'>"+src_thum+"</div><div class='col-lg-2'><div class='btn-group-action pull-right'><p><input id="+<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value['id_slide'];?>
+" class='btn-delete btn btn-danger' type='button'  value='Delete'></p></div></div><input id='leoslide_"+<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value['id_slide'];?>
					  ...
					  <div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only"><?php echo smartyTranslate(array('s'=>'Close'),$_smarty_tpl);?>
</span></button>
							<h4 class="modal-title" id="myModalLabel"><?php echo smartyTranslate(array('s'=>'Image'),$_smarty_tpl);?>
</h4>
						  </div>
...
?>
											<li>
												<div class="row img-row">
													<a class="label-tooltip img-link" style="height:70px;overflow: hidden" title=""  data-toggle="tooltip" onclick="selectImage('image','<?php echo $_smarty_tpl->tpl_vars['image']->value;?>
','#main_image','<?php echo $_smarty_tpl->tpl_vars['pathimg']->value;?>
')" data-original-title="<?php echo $_smarty_tpl->tpl_vars['image']->value;?>
">
													<img class="select-img" width="70" src="<?php echo $_smarty_tpl->tpl_vars['pathimg']->value;?>
<?php echo $_smarty_tpl->tpl_vars['image']->value;?>
" alt="" title="" data-name="<?php echo $_smarty_tpl->tpl_vars['image']->value;?>
">
													</a>
												</div>
											</li>	
					  ...
					  <div class="modal-dialog">
						<div class="modal-content">
						  <div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel"><?php echo smartyTranslate(array('s'=>'Image Thum'),$_smarty_tpl);?>
</h4>
						  </div>
						  <div class="modal-body">
								<div class="form-group">
									<ul id="list-imgs">
										<?php  $_smarty_tpl->tpl_vars['thum'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['thum']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['thums']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['thum']->key => $_smarty_tpl->tpl_vars['thum']->value) {
$_smarty_tpl->tpl_vars['thum']->_loop = true;
?>
											<li>
												<div class="row img-row">
													<a class="label-tooltip img-link" style="height:70px;overflow: hidden" title=""  data-toggle="tooltip" onclick="selectImage('thum','<?php echo $_smarty_tpl->tpl_vars['thum']->value;?>
','#main_thum','<?php echo $_smarty_tpl->tpl_vars['paththum']->value;?>
')" data-original-title="<?php echo $_smarty_tpl->tpl_vars['thum']->value;?>
">
													<img class="select-img" width="70" src="<?php echo $_smarty_tpl->tpl_vars['paththum']->value;?>
<?php echo $_smarty_tpl->tpl_vars['thum']->value;?>
" alt="" title="" data-name="<?php echo $_smarty_tpl->tpl_vars['thum']->value;?>
">
													</a>
												</div>
											</li>	
		...
		<div class="form-group">
			<label class="control-label col-lg-3 " for="title"> <?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
 </label>
			<div class="col-lg-9">
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['id_lang_default']->value) {?>style="display:none"<?php }?>>
							<div class="col-lg-9"> 
					<?php }?>
						<input class="slide_title" id="title_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
" type="text"  name="title_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
" value="<?php if ($_smarty_tpl->tpl_vars['slide_edit']->value&&$_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_title']->value]) {?><?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_title']->value];?>
<?php }?>">
					<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
							</div>
							<div class="col-lg-2">
...
?>
	...
	<div class="form-group">
				<label class="control-label col-lg-3 " for="description"> <?php echo smartyTranslate(array('s'=>'Description'),$_smarty_tpl);?>
 </label>
				<div class="col-lg-9">
					<?php  $_smarty_tpl->tpl_vars['language'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['language']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['id_lang_default']->value) {?>style="display:none"<?php }?>>
								<div class="col-lg-9">
									<?php }?>
										<textarea id="description_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
" class="slide_description textarea-autosize" rows="10" cols="40" style="overflow: hidden; word-wrap: break-word; resize: none; height: 199px;" id="description_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
" name="description_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
"><?php if ($_smarty_tpl->tpl_vars['slide_edit']->value&&$_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_description']->value]) {?><?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_description']->value];?>
<?php }?></textarea>
									<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>	
								</div>
								<div class="col-lg-2">
...
?>
			...
			<div class="form-group">
				<label class="control-label col-lg-3 " for="title"> <?php echo smartyTranslate(array('s'=>'Image'),$_smarty_tpl);?>
 </label>
				<div class="col-lg-9">
						<?php  $_smarty_tpl->tpl_vars['language'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['language']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['id_lang_default']->value) {?>style="display:none"<?php }?>>
									<div class="col-lg-9"> 
							<?php }?>
								<div class="main_image" id="main_image_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
" type="text">
									<?php if ($_smarty_tpl->tpl_vars['slide_edit']->value&&isset($_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_image']->value])&&$_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_image']->value]) {?>
										<img class="select-img" height="100px" src="<?php echo $_smarty_tpl->tpl_vars['pathimg']->value;?>
<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_image']->value];?>
" data-image="<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_image']->value];?>
" title="">
										<input type='hidden' name="image_<?php echo $_smarty_tpl->tpl_vars['iso_code']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_image']->value];?>
">
									<?php }?>	
								</div>
							<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
...
?>
					...
					<a  data-toggle="modal" data-target="#image">
						<?php echo smartyTranslate(array('s'=>'Choose Image'),$_smarty_tpl);?>

					</a>	
				</div>
			</div>	
			<div class="form-group">
				<label class="control-label col-lg-3 " for="title"> <?php echo smartyTranslate(array('s'=>'Thumb'),$_smarty_tpl);?>
 </label>
				<div class="col-lg-9">
						<?php  $_smarty_tpl->tpl_vars['language'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['language']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['id_lang_default']->value) {?>style="display:none"<?php }?>>
									<div class="col-lg-9"> 
							<?php }?>
								<div class="main_thum" id="main_thum_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
" type="text">
									<?php if ($_smarty_tpl->tpl_vars['slide_edit']->value&&isset($_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_thum']->value])&&$_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_thum']->value]) {?>
										<img class="select-img" height="100px" src="<?php echo $_smarty_tpl->tpl_vars['paththum']->value;?>
<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_thum']->value];?>
" data-image="<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_thum']->value];?>
" title="">
										<input type='hidden' name="image_<?php echo $_smarty_tpl->tpl_vars['iso_code']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['slide_edit']->value[$_smarty_tpl->tpl_vars['t_thum']->value];?>
">
									<?php }?>	
								</div>
							<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
...
?>
						...
						<div id="contentSlides_<?php echo $_smarty_tpl->tpl_vars['item']->value['id_slide'];?>
" class="leo-slide col-lg-12" style="border: 1px solid #ccc;margin-top: 5px;padding: 5px;">
							<div class="col-lg-1"><?php echo $_smarty_tpl->tpl_vars['item']->value['id_slide'];?>
</div>
							<div class="col-lg-2"><?php if (isset($_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_title']->value])&&$_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_title']->value]) {?><?php echo $_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_title']->value];?>
<?php }?></div>
							<div class="col-lg-5"><?php if (isset($_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_image']->value])&&$_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_image']->value]) {?><img  src="<?php echo $_smarty_tpl->tpl_vars['pathimg']->value;?>
<?php echo $_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_image']->value];?>
" style="width:100px;height:50px" class="<?php echo $_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_image']->value];?>
"><?php }?></div>
							<div class="col-lg-2"><?php if (isset($_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_thum']->value])&&$_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_thum']->value]) {?><img  src="<?php echo $_smarty_tpl->tpl_vars['paththum']->value;?>
<?php echo $_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_thum']->value];?>
" style="width:25px;height:25px" class="<?php echo $_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['t_thum']->value];?>
"><?php }?></div>
							<div class="col-lg-2">
								<div class="btn-group-action pull-right">
								<p>
									<a class="btn-edit btn btn-info" href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
&id_slide=<?php echo $_smarty_tpl->tpl_vars['item']->value['id_slide'];?>
" <?php if ($_smarty_tpl->tpl_vars['slide_edit']->value&&$_smarty_tpl->tpl_vars['slide_edit']->value['id_slide']&&$_smarty_tpl->tpl_vars['slide_edit']->value['id_slide']==$_smarty_tpl->tpl_vars['item']->value['id_slide']) {?>style="display:none"<?php }?>/><?php echo smartyTranslate(array('s'=>'Edit','mod'=>'leotempcp'),$_smarty_tpl);?>
									...
									<input class="btn-delete btn btn-danger" type="button" id="<?php echo $_smarty_tpl->tpl_vars['item']->value['id_slide'];?>
" value="<?php echo smartyTranslate(array('s'=>'Delete','mod'=>'leotempcp'),$_smarty_tpl);?>
">
								</p>
								</div>
							</div>
							<input id="Tabs_<?php echo $_smarty_tpl->tpl_vars['item']->value['id_slide'];?>
" name="leoslide[]" value='<?php echo $_smarty_tpl->tpl_vars['item']->value['slide'];?>
' type="hidden"/>
						</div>
					 <?php } ?>
					<?php }?>				
		...
		<?php if ($_smarty_tpl->tpl_vars['input']->value['type']=='setting_tab') {?>
			...
			<script type="text/javascript">
				...
				$(".updatetabs").click( function(){
					var id_tab = <?php echo $_smarty_tpl->tpl_vars['tab_edit']->value['id_tab'];?>
;
			...
			var bgCatUrl = "<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
";
			...
			function getTabs(edit)
			 {
				...
				if(max != '-Infinity')
					...
					maxid = 1;	
				var this_lang = "tabtitle_<?php echo $_smarty_tpl->tpl_vars['iso_code']->value;?>
";
				...
				if(edit){
					<?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['id_tab']) {?>
					var html = "<div class='col-lg-1'>"+<?php echo $_smarty_tpl->tpl_vars['tab_edit']->value['id_tab'];?>
+"</div><div  class='col-lg-2'>"+this_title+"</div><div class='col-lg-3'>"+type+"</div><div class='col-lg-3'>"+categories+"</div><div  class='col-lg-1'>"+src_img+"</div><div class='col-lg-2'><div class='btn-group-action pull-right'><p><input id="+<?php echo $_smarty_tpl->tpl_vars['tab_edit']->value['id_tab'];?>
+" class='btn-delete btn btn-danger' type='button'  value='Delete'></p></div></div><input id='Tabs_"+<?php echo $_smarty_tpl->tpl_vars['tab_edit']->value['id_tab'];?>
+"' name='leotab[]' value='"+mytab+"' type='hidden'/>";
			...
			<hr>	
					<div class="form-group">
									<label class="control-label col-lg-3 " for="tabtitle"> <?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
 </label>
									<div class="col-lg-9">
										<?php  $_smarty_tpl->tpl_vars['language'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['language']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" <?php if ($_smarty_tpl->tpl_vars['language']->value['id_lang']!=$_smarty_tpl->tpl_vars['id_lang_default']->value) {?>style="display:none"<?php }?>>
													<div class="col-lg-9"> 
											<?php }?>
												<input class="tabtitle" id="tabtitle_<?php echo $_smarty_tpl->tpl_vars['language']->value['iso_code'];?>
" type="text"  name="tabtitle_<?php echo intval($_smarty_tpl->tpl_vars['language']->value['id_lang']);?>
" value="<?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value[$_smarty_tpl->tpl_vars['t_title']->value]) {?><?php echo $_smarty_tpl->tpl_vars['tab_edit']->value[$_smarty_tpl->tpl_vars['t_title']->value];?>
<?php }?>">
											<?php if (count($_smarty_tpl->tpl_vars['languages']->value)>1) {?>
													</div>
													<div class="col-lg-2">
...
?>
							...
							<div class="form-group">
									<label class="control-label col-lg-3 " for="tabtype"> <?php echo smartyTranslate(array('s'=>'Type'),$_smarty_tpl);?>
 </label>
									<div class="col-lg-9">
										<div class="col-lg-9 ">
											<select id="tabtype" class=" fixed-width-xl" name="tabtype">
												...
												<option value="special" <?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['type']=='special') {?> selected="selected" <?php }?> ><?php echo smartyTranslate(array('s'=>'Special '),$_smarty_tpl);?>
</option>
												<option value="bestseller" <?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['type']=='bestseller') {?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'BestSeller '),$_smarty_tpl);?>
</option>
												<option value="featured" <?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['type']=='featured') {?> selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'Featured '),$_smarty_tpl);?>
</option>
												<option value="new" <?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['type']=='new') {?>	selected="selected" <?php }?>><?php echo smartyTranslate(array('s'=>'New Arrials  '),$_smarty_tpl);?>
</option>
											</select>
										</div>	
									</div>
							...
							<div class="form-group">
									<label class="control-label col-lg-3 " for="icon"> <?php echo smartyTranslate(array('s'=>'Icon'),$_smarty_tpl);?>
 </label>
									<div class="col-lg-9">
										<div class="col-lg-9 ">
											<select id="icon" class=" fixed-width-xl" name="icon">
												<option value="none"><?php echo smartyTranslate(array('s'=>'--None--'),$_smarty_tpl);?>
</option>
...
" <?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['icon']==$_smarty_tpl->tpl_vars['image']->value) {?> selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['image']->value;?>
</option>
													<?php } ?>
												<?php }?>
											</select>
...
">
					...
					<div class="form-group">
						<div class="col-lg-offset-3">
							<div  class="col-lg-9">
								<div class="col-lg-1"><?php echo smartyTranslate(array('s'=>'Id'),$_smarty_tpl);?>
</div>
								<div class="col-lg-2"><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</div>
								<div class="col-lg-3"><?php echo smartyTranslate(array('s'=>'Type'),$_smarty_tpl);?>
</div>
								<div class="col-lg-3" ><?php echo smartyTranslate(array('s'=>'Categories'),$_smarty_tpl);?>
</div>
								<div class="col-lg-1" ><?php echo smartyTranslate(array('s'=>'Icon'),$_smarty_tpl);?>
</div>
								<div class="col-lg-2 " style="text-align:right;"><?php echo smartyTranslate(array('s'=>'Action'),$_smarty_tpl);?>
</div>
							</div>
						</div>	
					</div>
...
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
								<div id="contentTabs_<?php echo $_smarty_tpl->tpl_vars['item']->value['id_tab'];?>
" class="leo-tab col-lg-9" style="border: 1px solid #ccc;margin-top: 5px;padding: 5px;">
									<div class="col-lg-1"><?php echo $_smarty_tpl->tpl_vars['item']->value['id_tab'];?>
</div>
									<div class="col-lg-2"><?php if (isset($_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['text_title']->value])&&$_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['text_title']->value]) {?><?php echo $_smarty_tpl->tpl_vars['item']->value[$_smarty_tpl->tpl_vars['text_title']->value];?>
<?php }?></div>
									<div class="col-lg-3"><?php if ($_smarty_tpl->tpl_vars['item']->value['type']) {?><?php echo $_smarty_tpl->tpl_vars['item']->value['type'];?>
<?php }?></div>
									<div class="col-lg-3"><?php echo implode(', ',$_smarty_tpl->tpl_vars['item']->value['categories']);?>
</div>
									<div class="col-lg-1">
										<?php if ($_smarty_tpl->tpl_vars['item']->value['icon']&&$_smarty_tpl->tpl_vars['item']->value['icon']!='none') {?><img  src="<?php echo $_smarty_tpl->tpl_vars['path']->value;?>
<?php echo $_smarty_tpl->tpl_vars['item']->value['icon'];?>
" style="width:30px;" class="<?php echo $_smarty_tpl->tpl_vars['item']->value['icon'];?>
"><?php }?>
									</div>
									<div class="col-lg-2">
										<div class="btn-group-action pull-right">
										<p>
												<a class="btn-edit btn btn-info" href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
&id_tab=<?php echo $_smarty_tpl->tpl_vars['item']->value['id_tab'];?>
" <?php if ($_smarty_tpl->tpl_vars['tab_edit']->value&&$_smarty_tpl->tpl_vars['tab_edit']->value['id_tab']&&$_smarty_tpl->tpl_vars['tab_edit']->value['id_tab']==$_smarty_tpl->tpl_vars['item']->value['id_tab']) {?>style="display:none"<?php }?>/><?php echo smartyTranslate(array('s'=>'Edit','mod'=>'leotempcp'),$_smarty_tpl);?>
											...
											<input class="btn-delete btn btn-danger" type="button" id="<?php echo $_smarty_tpl->tpl_vars['item']->value['id_tab'];?>
" value="<?php echo smartyTranslate(array('s'=>'Delete','mod'=>'leotempcp'),$_smarty_tpl);?>
">
										</p>
										</div>
									</div>
									<input id="Tabs_<?php echo $_smarty_tpl->tpl_vars['item']->value['id_tab'];?>
" name="leotab[]" value='<?php echo $_smarty_tpl->tpl_vars['item']->value['tab'];?>
' type="hidden"/>
								</div>
							 <?php } ?>
							<?php }?>
...
[]" id="chk_<?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
" value="<?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
"/>
                            </td>
                            <td><label for="chk_<?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
" class="t"><strong><?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
</strong></label></td>
                            <td>
                                <?php if (isset($_smarty_tpl->tpl_vars['module']->value['files'])) {?>
                                <select name="file_<?php echo $_smarty_tpl->tpl_vars['module']->value['name'];?>
">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '6615a78b4e2b11606-29765040');
content_5a78b4e32cc4f8_34232834($_smarty_tpl);
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2018-02-05 14:47:47
         compiled from "C:\xampp\htdocs\prestashop_pruebas\admin455dhvxiw\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_5a78b4e32cc4f8_34232834')) {function content_5a78b4e32cc4f8_34232834($_smarty_tpl) {?>
